/*
 * $Id: index.js Oct 9, 2015 9:42:13 AM tta1516$
 * 
...
var app = {
    ...
    receivedEvent: function(id) {
    	...
    	for(var i=1;i<tests.total;i++) {
     	...
     	$("#prev-0").remove();//Quitar el botón prev e la página 0
     	$("#next-"+(test.total-1)).attr("href","page-0");//Cambiar el href del botón next de la última page para que lleve a la page-0
