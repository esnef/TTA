/*
 * $Id: objects.js Oct 9, 2015 9:41:08 AM tta1516$
 * 
...
//		alert("create1");
		...
		var headerDiv=
			'<div data-role="header" data-position="fixed" >'+
				'<h1 style="margin-left:0;margin-right:0;white-space: nowrap;overflow: visible;">TTA1516_LS-EX_08v3: test3</h1>'+
			'</div>';
		...
		//Añadir encabezado, contenido y pie al page
...
//		alert("load1");
     	...
     	//poner el href del botón prev a la page anterior
     	$("#prev-"+i).attr("href","#page-"(i-1));
     	$("#next-"+i).attr("href","#page-"(i+1));

     	//poner el href del botón next a la page siguiente
//			alert("load7");
 	}
}
