/*
 * $Id: objects.js Oct 23, 2015 9:33:07 PM tta1516$
 * 
...
//	serverURL: "http://158.227.64.57:8080/"+"TTA1516_LS-EX_8S/", //EHU public
	localPermanentStorageFolder: "/sdcard/eus.ehu.INTEL901_504021.TTA1516_LS_EX_10v1/"
};
...
//		alert("create1");
		...
		var headerDiv=
			'<div data-role="header" data-position="fixed" >'+
				'<h1 style="margin-left:0;margin-right:0;white-space: nowrap;overflow: visible;">TTA1516_LS-EX_10v1: test8</h1>'+
			'</div>';
...
var fileUtilities = {
		downloadOpenPDf:function(url,folde,fileName){
			
		} //Método para descargar y abrir ficheros pdf
		,
		downloadOpenZIP:function(url,fileFolder,fileName){
			
		}//Método para descargar y abrir ficheros zip
	};
