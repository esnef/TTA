...
function sendResult(i) {
	...
	if(uploadFile==true)
		fileUtilities.uploadFileAsync(solutions.solution[i].exerciseSolution,exercises.exercise[i].exerciseType,appConstants.uploadFileURL,false);//Subir el fichero de la solución correspondiente al servicio de subida de ficheros
}
