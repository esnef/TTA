...
function login() {
	...
	solutionsUtils.empty(solutions);//vaciar el objeto solutions
	solutions.login=loginVal;//Guardar el nuevo login en soluions
...
function saveWork() {
	fileUtilities.writeContentToFileAsync(appConstants.persistentStorageFolder(),appConstants.persistentStorageSolutionsFile,solutions,false);//Guardar el objeto solutions en el fichero de la carpeta indicada en appConstants para ello
}
