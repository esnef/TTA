					...
					fileEntry.file(//Obtener el objeto File asociado
						function(file) {//función successCallback: si el objeto file se creó
							...
							reader.onloadend=function(){//Preparar la función a ejecutar cuando se termine la lectura
								fileUtilities.contentRead=reader.result;//Guardar en el atributo contentRead el contenido leído
								if(onSuccess!=false)
									onSuccess();								
							}
...
var audio = {
		...
		}//Método para empezar grabación
		,
		doStopRecordAsync: function(f,ff,o){
			
		}//Método asíncrono para terminar grabación
...
var video = {
		fileFolder:null,
		fileName:null,
		recordAsync: function(f,ff,o){
			
		}//Método asíncrono para grabar video		
};
