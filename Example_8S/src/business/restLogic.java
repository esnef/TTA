...
/*	
	...
	public LessonsJSON requestLessons() {
		...
		{//Para cada lección de la lista
			Lesson l=lessonsList.get(i);
			//Crear objeto LessonJSON, copiando lessonCode y title
			//Añadir objeto LessonJSON creado a la lista lessonJSONList
		}
		//Meter la lista lessonJSONList en el objeto lessonsJSON
